          ...
          >
            ...
            >
              <div style={{ display: "grid", gap: 6 }}>
                ...
                <h3 style={{ margin: 0, color: "#0f172a", fontSize: "1.35rem" }}>{group.title}</h3>
                <p style={{ margin: 0, color: "#475569", lineHeight: 1.6 }}>
                  Record review-safe status and evidence for each step in this section.
                </p>
              </div>
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                <ProgressChip label="pending" value={counts.pending} tone="#475569" />
                <ProgressChip label="manual" value={counts.manual} tone="#0369a1" />
                <ProgressChip label="automated" value={counts.automated} tone="#166534" />
